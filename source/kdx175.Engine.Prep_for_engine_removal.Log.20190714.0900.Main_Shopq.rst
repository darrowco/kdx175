...
Title of an example section with an online video
------------------------------------------------
...
Title of an example section with an online image
------------------------------------------------

How to embed an image that is hosted on online.
This is on a new line.
...
.. raw:: html
    ...
    <div style="text-align: center; margin-bottom: 2em;">
    <iframe width="100%" height="350" src="https://secure.zeald.com/site/bearingses/images/items/NR_BALL_BEARING.jpg?rel=0" frameborder="0" allowfullscreen></iframe>
    <a href="https://secure.zeald.com/site/bearingses/images/items/NR_BALL_BEARING.jpg" style="position:absolute; top:0; left:0; display:inline-block; height:350px; z-index:5;"></a>
    </div>
