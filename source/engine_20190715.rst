Prep for engine removal_01 poi
==========================
...
+--------------------------------------------------+------------------------------------------------------------------+
| Aug-03-2019                                      |Click here to see the `entire Log Entry <engine_20190715.html>`__ |
+==================================================+==================================================================+
...
.. raw:: html
  ...
  $(document).ready(function() {
    ...
    <thead>
    <tr>
    <th> #      </th><th> Description, part#, etc    </th><th> Source         </th><th class="sum"> Cost      </th>
    </tr>
    </thead>
    <tfoot>
        <tr>
...
.. raw:: html
    ...
    <tr>
    <td> 1      </td><td> Axle Nut                   </td><td> Yamabits       </td><td align="right"> 8.79      </td>
    </tr>
    <tr>
    <td> 2      </td><td> Piston         </td>       <td> Yamaha Dealer       </td><td align="right"> 128.43    </td>
     </tr>
    </tbody>
    </table>
