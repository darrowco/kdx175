...
| | by hand                                        |    Finding the floor jack                                        |
+--------------------------------------------------+------------------------------------------------------------------+
...
.. raw:: html
  ...
  $(document).ready(function() {
    ...
    <thead>
    <tr>
    <th> #  </th><th align="left"> Description, part#, etc    </th><th align="left"> Source         </th><th class="sum">       Cost</th><th class="sum">  Hours</th>
    </tr>
    </thead>
    <tfoot>
        <tr>
...
.. raw:: html
    ...
    <tr>
    <td> 1  </td><td> The legend consists of all elements after the caption. In this case, the legend consists of this paragraph and the following table                   </td><td> Yamabits       </td><td align="right">       8.79</td><th  align="right">   1.00</th>
    </tr>
    <tr>
    <td> 2  </td><td> Piston                     </td><td> Yamaha Dealer       </td><td align="right">     128.43</td><th  align="right">   6.25</th>
     </tr>
    <tr>
    <td> 1  </td><td> My time/Labor              </td><td> Piston pin fitment  </td><td align="right">      30.00</td><th  align="right">       </th>
     </tr>
    </tbody>
    </table>
